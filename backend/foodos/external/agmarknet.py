...
Moved here from `foodos/ingest/` — this describes the mandi, not our inventory,
which makes it external data rather than an ingest path.
`foodos.ingest.agmarknet` still resolves via a shim so nothing downstream broke.
