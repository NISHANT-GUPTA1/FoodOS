...
> **This is the kitchen node's deck outline, from the v1 team split.** It is not superseded and
...
> strings. The farm-gate batch product's deck outline is in [`deck-outline.md`](deck-outline.md).
