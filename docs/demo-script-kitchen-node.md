...
> **This is the kitchen node's demo script, from the v1 team split.** It is not superseded and
...
> strings. The farm-gate batch product's demo script is in [`demo-script.md`](demo-script.md).
